package com.sean.activiti.util;
...
public class Result {
    ...
    public Result redirectUrl(String redirectUrl){
    ...
    public Result putExtra(String name, Object val){
        ((HashMap<String, Object>)data.get("extra")).put(name, val);
        return this;
    }
    public Result setObjData(Object obj){
        data.put("obj", obj);
        return this;
    }

    public Result rows(Rows rows){
        setRows(rows);
        return this;
    }
    ...
    public Result setRows(Rows rows) {
        data.put("rows", rows);
        return this;
    }

    public Result setRows(int page, int rowSize, long count, List list) {
        Rows rows = Rows.buildRows(page, rowSize, count, list);
        data.put("rows", rows);
        return this;
    }
    ...
    public static class Rows{
        ...
        public static Rows buildRows(int page, int rowSize, long count, List list){
            return buildRows().setCurrent(page)
